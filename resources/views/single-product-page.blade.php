                    ...
                    <div class="grid gap-4">
                        ...
                        <div id="main-image-container">
                            <img id="main-image"
                                ...
                                src="{{ asset('images/products/1.jpg') }}" alt="Main Product Image" />
                        </div>
                        <!-- Small Images -->
                ...
                <div class="w-full lg:w-1/2 flex flex-col justify-between">
                    <div class="pb-8 border-b border-gray-line">
                        ...
                        <div class="flex items-center mb-8">
                            ...
                            <a href="#" class="ml-4 text-[#ff0042] font-semibold">Write a review</a>
                        </div>
                        <div class="mb-4 pb-4 border-b border-gray-line">
                            <p class="mb-2">Brand:<strong><a href="#" class="hover:text-[#ff0042]"> Nike</a></strong>
                            </p>
                        ...
                        <div class="flex items-center mb-8">
                            <button id="decrease"
                                class="bg-[#ff0042] hover:bg-transparent border border-transparent hover:border-[#ff0042] text-white hover:text-[#ff0042] font-semibold w-10 h-10 rounded-full flex items-center justify-center focus:outline-none"
                                disabled>-</button>
                        ...
                        <button
                            class="bg-[#ff0042] border border-transparent hover:bg-transparent hover:border-[#ff0042] text-white hover:text-[#ff0042] font-semibold py-2 px-4 rounded-full">Add
                            to Cart</button>
                    </div>
                    <!-- Social sharing -->
                    ...
                    <div id="description-content" role="tabpanel" aria-labelledby="description-tab" class="tab-content">
                        <div class="flex flex-col lg:flex-row lg:space-x-8">
                            ...
                            <div class="w-full lg:w-1/4">
                                ...
                                <p class="mb-2 pb-2 border-b border-gray-line">Fabric: <span class="font-semibold">Soft
                                        jersey</span></p>
                        ...
                        <div class="flex flex-col space-y-8">
                            <div>
                                ...
                                <p class="text-base text-gray-700">
                                    Available colors:
                                    <a href="#" class="text-[#ff0042] hover:underline">Red</a>,
                                    <a href="#" class="text-[#ff0042] hover:underline">Blue</a>,
                                    <a href="#" class="text-[#ff0042] hover:underline">Green</a>,
                                    <a href="#" class="text-[#ff0042] hover:underline">Black</a>,
                                    <a href="#" class="text-[#ff0042] hover:underline">White</a>.
                                </p>
                            </div>
                            <div>
                                ...
                                <p class="text-base text-gray-700">
                                    ...
                                    <a href="#" class="text-[#ff0042] hover:underline">Nike</a>.
                                </p>
                            </div>
                            <div>
                            ...
                            <div id="reviews-list">
                                ...
                                <div class="py-4">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="ml-2 text-[#ff0042]">★★★★★</span>
                                    </div>
                            ...
                            <form id="review-form" class="space-y-4">
                                <div class="space-y-4 md:flex md:space-x-4 md:space-y-0">
                                    <div class="md:flex-1">
                                        ...
                                        <input type="text" id="review-name" name="review-name"
                                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#ff0042] focus:border-[#ff0042] sm:text-sm">
                                    </div>
                                    <div class="md:flex-1">
                                ...
                                <div>
                                    ...
                                    <textarea id="review-text" name="review-text" rows="4"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#ff0042] focus:border-[#ff0042] sm:text-sm"></textarea>
                                </div>
                                <div>
                                    <button type="submit"
                                        class="bg-[#ff0042] hover:bg-transparent border border-transparent hover:border-[#ff0042] text-white hover:text-[#ff0042] font-semibold py-2 px-4 rounded-full focus:outline-none">Submit
                                        Review</button>
                                </div>
                            </form>
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                <div class="bg-white p-3 rounded-lg shadow-lg">
                    ...
                    <button
                        class="bg-[#ff0042] border border-transparent hover:bg-transparent hover:border-[#ff0042] text-white hover:text-[#ff0042] font-semibold py-2 px-4 rounded-full w-full">Add
                        to Cart</button>
                </div>
            </div>
            <!-- Product 2 -->
