                        ...
                        <form method="POST"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="image" class="block text-sm font-medium text-gray-700">New
                                            Product
                                            Image</label>
                                        ...
                                        @error('image')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}
                                                {{ asset('storage/' . $product->media->first()->path) }}</p>
                                        @enderror
                                        ...
                                        @if ($product && $product->media->first())
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ asset('storage/' . $product->media->first()->path) }}"
                                                    ...
                                                    class="h-32 w-32 object-cover rounded-md" width="100">
                                            </div>
                                        @endif
                                    </div>
                                </div>
