...
<div class="flex justify-center items-center space-x-2">
    @if($viewUrl)
        ...
        <div class="relative group">
            ...
            <span class="absolute z-10 invisible group-hover:visible bg-gray-800 text-white text-xs rounded py-1 px-2 -bottom-7 left-1/2 transform -translate-x-1/2 whitespace-nowrap">View</span>
        </div>
        @endcan
    @endif
    @if($editUrl)
