...
<head>
    ...
    <title>Pak Discounts API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-products--product_id-">Display the specified resource.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products-shop">
                                <a href="#endpoints-GETapi-products-shop">GET api/products/shop</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products-filter">GET api/products/filter</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products--product_id--public-detail">
                                <a href="#endpoints-GETapi-products--product_id--public-detail">GET api/products/{product_id}/public-detail</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-cart-add">POST api/cart/add</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-cart-remove">
                                <a href="#endpoints-POSTapi-cart-remove">POST api/cart/remove</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-orders--order_id--cancel">POST api/orders/{order_id}/cancel</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-orders--order_id--invoice">
                                <a href="#endpoints-GETapi-orders--order_id--invoice">GET api/orders/{order_id}/invoice</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-admin-orders">GET api/admin/orders</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-orders--order_id-">
                                <a href="#endpoints-GETapi-admin-orders--order_id-">GET api/admin/orders/{order_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-admin-orders--order_id-">
                                <a href="#endpoints-PUTapi-admin-orders--order_id-">PUT api/admin/orders/{order_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-admin-orders--order_id-">
                                <a href="#endpoints-DELETEapi-admin-orders--order_id-">DELETE api/admin/orders/{order_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-conversations">GET api/conversations</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-conversations">
                                <a href="#endpoints-POSTapi-conversations">POST api/conversations</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-roles">Store a newly created resource in storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-roles--role-">
                                <a href="#endpoints-PUTapi-roles--role-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-roles--role-">
                                <a href="#endpoints-DELETEapi-roles--role-">Remove the specified resource from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-profile">
                                <a href="#endpoints-GETapi-profile">Display the user's profile form.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-profile">Delete the user's account.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products-export">
                                <a href="#endpoints-GETapi-products-export">GET api/products/export</a>
                            </li>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's name. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="roles"                data-endpoint="POSTapi-users"
               value=""
               data-component="body">
    <br>
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products-shop">GET api/products/shop</h2>
...
<span id="example-requests-GETapi-products-shop">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/products/shop" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/products/shop"
);
...
<span id="example-responses-GETapi-products-shop">
            <blockquote>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Product] shop&quot;
}</code>
 </pre>
    </span>
<span id="execution-results-GETapi-products-shop" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-shop"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-shop"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-products-shop" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-shop">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-products-shop" data-method="GET"
      data-path="api/products/shop"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products-shop', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-shop"
                    onclick="tryItOut('GETapi-products-shop');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-shop"
                    onclick="cancelTryOut('GETapi-products-shop');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-shop"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/shop</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-products-shop"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-products-shop"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/products/filter" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Product] filter&quot;
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--product_id--public-detail">GET api/products/{product_id}/public-detail</h2>
...
<span id="example-requests-GETapi-products--product_id--public-detail">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/products/1/public-detail" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/products/1/public-detail"
);
...
<span id="example-responses-GETapi-products--product_id--public-detail">
            <blockquote>
...
&lt;head&gt;
    ...
    &lt;!-- Favicon --&gt;
    &lt;link rel=&quot;icon&quot; type=&quot;icon&quot; href=&quot;http://127.0.0.1:8000/images/favicon.png&quot; /&gt;
    &lt;title&gt;Poduct detail&lt;/title&gt;
    ...
    &lt;link rel=&quot;stylesheet&quot; href=&quot;http://127.0.0.1:8000/css/tailwind.css&quot;&gt;
...
&lt;body&gt;
    ...
    &lt;header class=&quot;bg-gray-dark sticky top-0 z-50&quot;&gt;
        &lt;div class=&quot;container mx-auto flex justify-between items-center py-4&quot;&gt;
            ...
            &lt;a href=&quot;index.html&quot; class=&quot;flex items-center&quot;&gt;
                &lt;div&gt;
                    &lt;img src=&quot;http://127.0.0.1:8000/images/template-white-logo.png&quot; alt=&quot;Logo&quot; class=&quot;h-14 w-auto mr-4&quot;&gt;
                &lt;/div&gt;
            &lt;/a&gt;
            ...
            &lt;nav class=&quot;hidden lg:flex md:flex-grow justify-center&quot;&gt;
                &lt;ul class=&quot;flex justify-center space-x-4 text-white&quot;&gt;
                    &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000&quot; class=&quot;hover:text-[#ff0042] font-semibold&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;
                    &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/shop&quot; class=&quot;hover:text-[#ff0042] font-semibold&quot;&gt;Shop&lt;/a&gt;&lt;/li&gt;
                    ...
                    &lt;li class=&quot;relative group&quot;&gt;
                        ...
                        &lt;ul class=&quot;absolute left-0 mt-0 w-40 bg-white text-gray-800 rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition z-50&quot;&gt;
                            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/faq&quot; class=&quot;block px-4 py-2 hover:bg-gray-100 transition&quot;&gt;FAQ&lt;/a&gt;&lt;/li&gt;
                            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/support&quot; class=&quot;block px-4 py-2 hover:bg-gray-100 transition&quot;&gt;Support&lt;/a&gt;&lt;/li&gt;
                            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/returns&quot; class=&quot;block px-4 py-2 hover:bg-gray-100 transition&quot;&gt;Returns&lt;/a&gt;&lt;/li&gt;
                        &lt;/ul&gt;
                    &lt;/li&gt;
                    &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/contact&quot; class=&quot;hover:text-[#ff0042] font-semibold&quot;&gt;Contact&lt;/a&gt;&lt;/li&gt;
                    &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/checkout&quot; class=&quot;hover:text-[#ff0042] font-semibold&quot;&gt;Checkout&lt;/a&gt;&lt;/li&gt;
                &lt;/ul&gt;
            &lt;/nav&gt;
            ...
            &lt;div class=&quot;hidden lg:flex items-center space-x-4 relative&quot;&gt;
                ...
                &lt;div class=&quot;relative group cart-wrapper&quot;&gt;
                    &lt;a href=&quot;http://127.0.0.1:8000/cart&quot;&gt;
                        &lt;img src=&quot;http://127.0.0.1:8000/images/cart-shopping.svg&quot; alt=&quot;Cart&quot;
                            class=&quot;h-6 w-6 group-hover:scale-120&quot;&gt;
                        &lt;span class=&quot;cart-count absolute -top-2 -right-2 bg-[#ff0042] text-white text-xs font-bold rounded-full px-2 py-0.5&quot;&gt;0&lt;/span&gt;
                    &lt;/a&gt;
                    &lt;!-- Cart dropdown --&gt;
                    &lt;div
    ...
    &lt;/div&gt;
                ...
                &lt;!-- &lt;a id=&quot;search-icon&quot; href=&quot;javascript:void(0);&quot; class=&quot;text-white hover:text-[#ff0042] group&quot;&gt;
                    &lt;img src=&quot;http://127.0.0.1:8000/images/search-icon.svg&quot; alt=&quot;Search&quot;
    ...
    &lt;nav id=&quot;mobile-menu-placeholder&quot; class=&quot;mobile-menu hidden flex-col items-center space-y-8 lg:hidden&quot;&gt;
        &lt;ul class=&quot;w-full&quot;&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/shop&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Shop&lt;/a&gt;&lt;/li&gt;
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/checkout&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Checkout&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/contact&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Contact&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/faq&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;FAQ&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/support&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Support&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/returns&quot; class=&quot;hover:text-[#ff0042] font-bold block py-2&quot;&gt;Returns&lt;/a&gt;&lt;/li&gt;
        &lt;/ul&gt;
...
&lt;section id=&quot;breadcrumbs&quot; class=&quot;pt-6 bg-gray-50&quot;&gt;
    &lt;div class=&quot;container mx-auto px-4&quot;&gt;
        &lt;ol class=&quot;list-reset flex&quot;&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000&quot; class=&quot;font-semibold hover:text-[#ff0042]&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;span class=&quot;mx-2&quot;&gt;&amp;gt;&lt;/span&gt;&lt;/li&gt;
            &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/shop&quot; class=&quot;font-semibold hover:text-[#ff0042]&quot;&gt;Shop&lt;/a&gt;&lt;/li&gt;
            &lt;li&gt;&lt;span class=&quot;mx-2&quot;&gt;&amp;gt;&lt;/span&gt;&lt;/li&gt;
            ...
            &lt;div class=&quot;flex flex-col lg:flex-row gap-6&quot;&gt;
                    ...
                    &lt;div class=&quot;grid gap-4&quot;&gt;
                        ...
                        &lt;div id=&quot;main-image-container&quot;&gt;
                            &lt;img id=&quot;main-image&quot;
                                ...
                                src=&quot;http://127.0.0.1:8000/storage/products/BCmB0vL6x1aoXTZnbTqinpkdOQndhcaPVLfZssFo.jpg&quot; alt=&quot;Main Product Image&quot; /&gt;
                        ...
                        &lt;div class=&quot;grid grid-cols-5 gap-4&quot;&gt;
                            &lt;div&gt;
                                &lt;img onclick=&quot;changeImage(this)&quot; data-full=&quot;http://127.0.0.1:8000/images/single-product/1.jpg&quot;
                                    src=&quot;http://127.0.0.1:8000/images/single-product/1.jpg&quot;
                                    class=&quot;object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer&quot;
                                    alt=&quot;Gallery Image 1&quot; /&gt;
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;img onclick=&quot;changeImage(this)&quot; data-full=&quot;http://127.0.0.1:8000/images/single-product/2.jpg&quot;
                                    src=&quot;http://127.0.0.1:8000/images/single-product/2.jpg&quot;
                                    class=&quot;object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer&quot;
                                    alt=&quot;Gallery Image 2&quot; /&gt;
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;img onclick=&quot;changeImage(this)&quot; data-full=&quot;http://127.0.0.1:8000/images/single-product/3.jpg&quot;
                                    src=&quot;http://127.0.0.1:8000/images/single-product/3.jpg&quot;
                                    class=&quot;object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer&quot;
                                    alt=&quot;Gallery Image 3&quot; /&gt;
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;img onclick=&quot;changeImage(this)&quot; data-full=&quot;http://127.0.0.1:8000/images/single-product/4.jpg&quot;
                                    src=&quot;http://127.0.0.1:8000/images/single-product/4.jpg&quot;
                                    class=&quot;object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer&quot;
                                    alt=&quot;Gallery Image 4&quot; /&gt;
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;img onclick=&quot;changeImage(this)&quot; data-full=&quot;http://127.0.0.1:8000/images/single-product/5.jpg&quot;
                                    src=&quot;http://127.0.0.1:8000/images/single-product/5.jpg&quot;
                                    class=&quot;object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer&quot;
                                    alt=&quot;Gallery Image 5&quot; /&gt;
                            &lt;/div&gt;
                        &lt;/div&gt;
                ...
                &lt;div class=&quot;w-full lg:w-1/2 flex flex-col justify-between&quot;&gt;
                    &lt;div class=&quot;pb-8 border-b border-gray-line&quot;&gt;
                        &lt;h1 class=&quot;text-3xl font-bold mb-4&quot;&gt;Melinda Nunez&lt;/h1&gt;
                        ...
                        &lt;div class=&quot;mb-4 pb-4 border-b border-gray-line&quot;&gt;
                            ...
                            &lt;p class=&quot;mb-2&quot;&gt;Availability:&lt;strong&gt;
                                &lt;span id=&quot;available-stock-1&quot;&gt;Loading...&lt;/span&gt;
                            &lt;/strong&gt;&lt;/p&gt;
                        &lt;/div&gt;
                        &lt;div class=&quot;text-2xl font-semibold mb-8&quot; data-unit-price=&quot;511.00&quot;&gt;$511.00&lt;/div&gt;
                        &lt;div class=&quot;flex items-center mb-8&quot;&gt;
                            &lt;button id=&quot;decrease&quot;
                            ...
                            &lt;input id=&quot;quantity&quot; type=&quot;number&quot; value=&quot;1&quot; min=&quot;1&quot; max=&quot;26&quot; class=&quot;w-16 py-2 text-center focus:outline-none&quot;&gt;
                            &lt;button id=&quot;increase&quot;
                    ...
                    &lt;div class=&quot;flex space-x-4 my-6&quot;&gt;
                        &lt;a href=&quot;#&quot; class=&quot;w-4 h-4 flex items-center justify-center&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/facebook.svg&quot; alt=&quot;Facebook&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110&quot;&gt;
                        &lt;/a&gt;
                        &lt;a href=&quot;#&quot; class=&quot;w-4 h-4 flex items-center justify-center&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/instagram.svg&quot; alt=&quot;Instagram&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110&quot;&gt;
                        &lt;/a&gt;
                        &lt;a href=&quot;#&quot; class=&quot;w-4 h-4 flex items-center justify-center&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/pinterest.svg&quot; alt=&quot;Pinterest&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110&quot;&gt;
                        &lt;/a&gt;
                        &lt;a href=&quot;#&quot; class=&quot;w-4 h-4 flex items-center justify-center&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/twitter.svg&quot; alt=&quot;Twitter&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110&quot;&gt;
                        &lt;/a&gt;
                        &lt;a href=&quot;#&quot; class=&quot;w-4 h-4 flex items-center justify-center&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/viber.svg&quot; alt=&quot;Viber&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110&quot;&gt;
                        &lt;/a&gt;
                    &lt;/div&gt;
        ...
        &lt;div class=&quot;container mx-auto px-4 py-10&quot;&gt;
            &lt;div class=&quot;flex flex-wrap -mx-4&quot;&gt;
                ...
                &lt;div class=&quot;w-full sm:w-1/6 px-4 mb-8&quot;&gt;
                    ...
                    &lt;ul&gt;
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/shop&quot; class=&quot;hover:text-[#ff0042]&quot;&gt;Shop&lt;/a&gt;&lt;/li&gt;
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/faq&quot; class=&quot;hover:text-[#ff0042]&quot;&gt;FAQ&lt;/a&gt;&lt;/li&gt;
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/contact&quot; class=&quot;hover:text-[#ff0042]&quot;&gt;Contact&lt;/a&gt;&lt;/li&gt;
                ...
                &lt;div class=&quot;w-full sm:w-1/6 px-4 mb-8&quot;&gt;
                    ...
                    &lt;ul&gt;
                        ...
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/register&quot; class=&quot;hover:text-[#ff0042]&quot;&gt;Registration&lt;/a&gt;&lt;/li&gt;
                        &lt;li&gt;&lt;a href=&quot;http://127.0.0.1:8000/login&quot; class=&quot;hover:text-[#ff0042]&quot;&gt;Login&lt;/a&gt;&lt;/li&gt;
                    &lt;/ul&gt;
                &lt;/div&gt;
                &lt;!-- Social Media --&gt;
                &lt;div class=&quot;w-full sm:w-1/6 px-4 mb-8&quot;&gt;
                    ...
                    &lt;ul&gt;
                        ...
                        &lt;/li&gt;
                        &lt;li class=&quot;flex items-center mb-2&quot;&gt;
                            &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/youtube.svg&quot; alt=&quot;YouTube&quot;
                                class=&quot;w-4 h-4 transition-transform transform hover:scale-110 mr-2&quot;&gt;
                ...
                &lt;div class=&quot;w-full sm:w-2/6 px-4 mb-8&quot;&gt;
                    ...
                    &lt;p&gt;&lt;img src=&quot;http://127.0.0.1:8000/images/template-logo.png&quot; alt=&quot;Logo&quot; class=&quot;h-[60px] mb-4&quot;&gt;&lt;/p&gt;
        ...
        &lt;div class=&quot;py-6 border-t border-gray-line&quot;&gt;
            &lt;div class=&quot;container mx-auto px-4 flex flex-wrap justify-between items-center&quot;&gt;
                ...
                &lt;div class=&quot;w-full lg:w-1/4 text-center lg:text-right&quot;&gt;
                    &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/paypal.svg&quot; alt=&quot;PayPal&quot; class=&quot;inline-block h-8 mr-2&quot;&gt;
                    &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/stripe.svg&quot; alt=&quot;Stripe&quot; class=&quot;inline-block h-8 mr-2&quot;&gt;
                    &lt;img src=&quot;http://127.0.0.1:8000/images/social_icons/visa.svg&quot; alt=&quot;Visa&quot; class=&quot;inline-block h-8&quot;&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/footer&gt;
...
<span id="execution-results-GETapi-products--product_id--public-detail" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products--product_id--public-detail"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products--product_id--public-detail"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-products--product_id--public-detail" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products--product_id--public-detail">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-products--product_id--public-detail" data-method="GET"
      data-path="api/products/{product_id}/public-detail"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products--product_id--public-detail', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products--product_id--public-detail"
                    onclick="tryItOut('GETapi-products--product_id--public-detail');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products--product_id--public-detail"
                    onclick="cancelTryOut('GETapi-products--product_id--public-detail');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products--product_id--public-detail"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/{product_id}/public-detail</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-products--product_id--public-detail"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-products--product_id--public-detail"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="GETapi-products--product_id--public-detail"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
...
<div class="bash-example">
    ...
    --form "image=@/tmp/phpI7Ou6Q" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpI7Ou6Q</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "stock=45"\
    --form "category_id=consequatur"\
    --form "image=@/tmp/php13uNr8" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/php13uNr8</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-cart-remove">POST api/cart/remove</h2>
...
<span id="example-requests-POSTapi-cart-remove">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-cart-remove">
</span>
<span id="execution-results-POSTapi-cart-remove" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-cart-remove"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-cart-remove"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-cart-remove" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-cart-remove">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-cart-remove" data-method="POST"
      data-path="api/cart/remove"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-cart-remove', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-cart-remove"
                    onclick="tryItOut('POSTapi-cart-remove');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-cart-remove"
                    onclick="cancelTryOut('POSTapi-cart-remove');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-cart-remove"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-cart-remove"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-cart-remove"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"billing_zip\": \"vmqeopfuudtdsufvy\",
    \"billing_phone\": \"vddqamniihfqcoynl\",
    \"payment_method\": \"cod\"
}"
</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>billing_zip</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="billing_zip"                data-endpoint="POSTapi-checkout"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="billing_phone"                data-endpoint="POSTapi-checkout"
...
Must be one of:
<ul style="list-style-type: square;"><li><code>cod</code></li> <li><code>bank</code></li></ul>
        </div>
        </form>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/orders/45"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>45</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/orders/45/cancel" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the order. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders--order_id--invoice">GET api/orders/{order_id}/invoice</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/orders/45/invoice" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/orders/45/invoice"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-orders--order_id-">GET api/admin/orders/{order_id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/admin/orders/45" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/admin/orders/45"
);
...
<p>The ID of the order. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-admin-orders--order_id-">PUT api/admin/orders/{order_id}</h2>
...
<span id="example-requests-PUTapi-admin-orders--order_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-admin-orders--order_id-">
</span>
<span id="execution-results-PUTapi-admin-orders--order_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-admin-orders--order_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-admin-orders--order_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-admin-orders--order_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-admin-orders--order_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-admin-orders--order_id-" data-method="PUT"
      data-path="api/admin/orders/{order_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-admin-orders--order_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-admin-orders--order_id-"
                    onclick="tryItOut('PUTapi-admin-orders--order_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-admin-orders--order_id-"
                    onclick="cancelTryOut('PUTapi-admin-orders--order_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-admin-orders--order_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-admin-orders--order_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-admin-orders--order_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="PUTapi-admin-orders--order_id-"
               value="45"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>45</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-admin-orders--order_id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-admin-orders--order_id-">DELETE api/admin/orders/{order_id}</h2>
...
<span id="example-requests-DELETEapi-admin-orders--order_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-admin-orders--order_id-">
</span>
<span id="execution-results-DELETEapi-admin-orders--order_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-admin-orders--order_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-admin-orders--order_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-admin-orders--order_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-admin-orders--order_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-admin-orders--order_id-" data-method="DELETE"
      data-path="api/admin/orders/{order_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-admin-orders--order_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-admin-orders--order_id-"
                    onclick="tryItOut('DELETEapi-admin-orders--order_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-admin-orders--order_id-"
                    onclick="cancelTryOut('DELETEapi-admin-orders--order_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-admin-orders--order_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-admin-orders--order_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-admin-orders--order_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="DELETEapi-admin-orders--order_id-"
               value="45"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>45</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-conversations">POST api/conversations</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="POSTapi-conversations"
               value="consequatur"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/conversations/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
    ...
    <br>
                    ...
                    <h2 id="endpoints-PUTapi-roles--role-">Update the specified resource in storage.</h2>
...
<span id="example-requests-PUTapi-roles--role-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-roles--role-">
</span>
<span id="execution-results-PUTapi-roles--role-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-roles--role-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-roles--role-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-roles--role-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-roles--role-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-roles--role-" data-method="PUT"
      data-path="api/roles/{role}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-roles--role-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-roles--role-"
                    onclick="tryItOut('PUTapi-roles--role-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-roles--role-"
                    onclick="cancelTryOut('PUTapi-roles--role-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-roles--role-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-roles--role-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-roles--role-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="PUTapi-roles--role-"
               value="consequatur"
               data-component="url">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-roles--role-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="permissions"                data-endpoint="PUTapi-roles--role-"
               value=""
               data-component="body">
    <br>
                    ...
                    <h2 id="endpoints-DELETEapi-roles--role-">Remove the specified resource from storage.</h2>
...
<span id="example-requests-DELETEapi-roles--role-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-roles--role-">
</span>
<span id="execution-results-DELETEapi-roles--role-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-roles--role-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-roles--role-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-roles--role-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-roles--role-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-roles--role-" data-method="DELETE"
      data-path="api/roles/{role}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-roles--role-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-roles--role-"
                    onclick="tryItOut('DELETEapi-roles--role-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-roles--role-"
                    onclick="cancelTryOut('DELETEapi-roles--role-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-roles--role-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-roles--role-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-roles--role-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="DELETEapi-roles--role-"
               value="consequatur"
               data-component="url">
    <br>
<p>The role. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-profile">Display the user&#039;s profile form.</h2>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products-export">GET api/products/export</h2>
...
<span id="example-requests-GETapi-products-export">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-products-export">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Product] export&quot;
}</code>
 </pre>
    </span>
<span id="execution-results-GETapi-products-export" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-export"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-export"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-products-export" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-export">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-products-export" data-method="GET"
      data-path="api/products/export"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products-export', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-export"
                    onclick="tryItOut('GETapi-products-export');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-export"
                    onclick="cancelTryOut('GETapi-products-export');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-export"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/export</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-products-export"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-products-export"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
