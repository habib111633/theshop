                            ...
                            <tbody id="cart-items">
                                    ...
                                    <td class="px-1 py-4">
                                        <div class="flex items-center flex-col sm:flex-row text-center sm:text-left">
                                            <img class="h-16 w-16 md:h-24 md:w-24 sm:mr-8 mb-4 sm:mb-0"
                                                src="{{ asset('images/single-product/1.jpg') }}" alt="Product image">
                                ...
                                <tr class="pb-4">
                                    <td class="px-1 py-4">
                                        <div class="flex items-center flex-col sm:flex-row text-center sm:text-left">
                                            <img class="h-16 w-16 md:h-24 md:w-24 sm:mr-8 mb-4 sm:mb-0"
                                                src="{{ asset('images/single-product/2.jpg') }}" alt="Product image">
                                    ...
                                    <td class="px-1 py-4 text-center">
                                        <div class="flex items-center justify-center">
                                            <button
                                                class="cart-decrement border border-[#ff0042]  bg-[#ff0042] text-white hover:bg-transparent hover:text-[#ff0042] rounded-full w-10 h-10 flex items-center justify-center">-</button>
                                            <p class="quantity text-center w-8">1</p>
                                            <button
                                                class="cart-increment border border-[#ff0042]  bg-[#ff0042] text-white hover:bg-transparent hover:text-[#ff0042] rounded-full w-10 h-10 flex items-center justify-center">+</button>
                                        </div>
                                    </td>
                                    <td class="px-1 py-4 text-right">$19.99</td>
                                </tr>
